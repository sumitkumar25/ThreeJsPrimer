...
const routes = [
    {
        path: 'three',
        loadChildren: () => __webpack_require__.e(/*! import() | three-three-module */ "three-three-module").then(__webpack_require__.bind(null, /*! ./three/three.module */ "./src/app/three/three.module.ts")).then(m => m.ThreeModule)
    },
    {
        path: 'pixi',
