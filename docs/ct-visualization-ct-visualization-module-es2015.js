...
/* harmony import */ var three_examples_jsm_controls_FlyControls_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! three/examples/jsm/controls/FlyControls.js */ "./node_modules/three/examples/jsm/controls/FlyControls.js");
...
/* harmony import */ var kapsule__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! kapsule */ "./node_modules/kapsule/dist/kapsule.module.js");
...
: {
  ...
  Raycaster: three__WEBPACK_IMPORTED_MODULE_0__["Raycaster"],
  ...
  BackSide: three__WEBPACK_IMPORTED_MODULE_0__["BackSide"],
  EventDispatcher: three__WEBPACK_IMPORTED_MODULE_0__["EventDispatcher"],
  MOUSE: three__WEBPACK_IMPORTED_MODULE_0__["MOUSE"],
  Quaternion: three__WEBPACK_IMPORTED_MODULE_0__["Quaternion"],
  Spherical: three__WEBPACK_IMPORTED_MODULE_0__["Spherical"],
  Clock: three__WEBPACK_IMPORTED_MODULE_0__["Clock"]
};
var threeRenderObjects = Object(kapsule__WEBPACK_IMPORTED_MODULE_9__["default"])({
  props: {
    width: {
      ...
      if (state.initialised) {
        ...
        if (state.enablePointerInteraction) {
          ...
          if (topObject !== state.hoverObj) {
            ...
            state.toolTipElem.innerHTML = topObject ? Object(accessor_fn__WEBPACK_IMPORTED_MODULE_8__["default"])(state.tooltipContent)(topObject) || '' : '';
            state.hoverObj = topObject;
          }
        }

        _tweenjs_tween_js__WEBPACK_IMPORTED_MODULE_7__["default"].update(); // update camera animation tweens
      }
    ...
    cameraPosition: function cameraPosition(state, position, lookAt, transitionDuration) {
      ...
      if (position && state.initialised) {
        ...
        if (!transitionDuration) {
          ...
          new _tweenjs_tween_js__WEBPACK_IMPORTED_MODULE_7__["default"].Tween(camPos).to(finalPos, transitionDuration).easing(_tweenjs_tween_js__WEBPACK_IMPORTED_MODULE_7__["default"].Easing.Quadratic.Out).onUpdate(setCameraPos).start(); // Face direction in 1/3rd of time

          new _tweenjs_tween_js__WEBPACK_IMPORTED_MODULE_7__["default"].Tween(camLookAt).to(finalLookAt, transitionDuration / 3).easing(_tweenjs_tween_js__WEBPACK_IMPORTED_MODULE_7__["default"].Easing.Quadratic.Out).onUpdate(setLookAt).start();
        }
  ...
  init: function init(domNode, state, _ref4) {
    ...
    state.controls = new {
      trackball: three_examples_jsm_controls_TrackballControls_js__WEBPACK_IMPORTED_MODULE_1__["TrackballControls"],
      orbit: three_examples_jsm_controls_OrbitControls_js__WEBPACK_IMPORTED_MODULE_2__["OrbitControls"],
      fly: three_examples_jsm_controls_FlyControls_js__WEBPACK_IMPORTED_MODULE_3__["FlyControls"]
  ...
  update: function update(state, changedProps) {
    ...
    if (changedProps.hasOwnProperty('backgroundColor')) {
      var alpha = Object(polished__WEBPACK_IMPORTED_MODULE_6__["parseToRgb"])(state.backgroundColor).alpha;
      if (alpha === undefined) alpha = 1;
      state.renderer.setClearColor(new three.Color(Object(polished__WEBPACK_IMPORTED_MODULE_6__["opacify"])(1, state.backgroundColor)), alpha);
    }
...
/* harmony default export */ __webpack_exports__["default"] = (threeRenderObjects);
...
/*!*****************************************************************!*\
  !*** ./node_modules/three/examples/jsm/controls/FlyControls.js ***!
  \*****************************************************************/
/*! exports provided: FlyControls */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FlyControls", function() { return FlyControls; });
...
var FlyControls = function ( object, domElement ) {
	...
	this.tmpQuaternion = new _build_three_module_js__WEBPACK_IMPORTED_MODULE_0__["Quaternion"]();

	this.mouseStatus = 0;

	this.moveState = { up: 0, down: 0, left: 0, right: 0, forward: 0, back: 0, pitchUp: 0, pitchDown: 0, yawLeft: 0, yawRight: 0, rollLeft: 0, rollRight: 0 };
	this.moveVector = new _build_three_module_js__WEBPACK_IMPORTED_MODULE_0__["Vector3"]( 0, 0, 0 );
	this.rotationVector = new _build_three_module_js__WEBPACK_IMPORTED_MODULE_0__["Vector3"]( 0, 0, 0 );
...
FlyControls.prototype = Object.create( _build_three_module_js__WEBPACK_IMPORTED_MODULE_0__["EventDispatcher"].prototype );
...
let CtGlobeGlIntfrastructureComponent = class CtGlobeGlIntfrastructureComponent {
    constructor() {
        this.awsUsRegions = [
            {
                lat: 40.367474,
    ...
    constructGlobe() {
        const globe = Object(globe_gl__WEBPACK_IMPORTED_MODULE_2__["default"])();
...
let CtGlobeInfrastructureComponent = class CtGlobeInfrastructureComponent {
    ...
    constructInfraGlobe() {
        ...
        const globe = new three_globe__WEBPACK_IMPORTED_MODULE_4__["default"]()
            .globeImageUrl('assets/earth-dark.jpg')
            .pointsData(this.awsUsRegions)
            .pointAltitude(0.0005)
            .pointColor(() => '#007FFF')
...
CtGlobeInfrastructureComponent.ctorParameters = () => [
...
let CtVisualizationComponent = class CtVisualizationComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let CtVisualizationRoutingModule = class CtVisualizationRoutingModule {
};
...
let CtVisualizationModule = class CtVisualizationModule {
};
...
let CtVisualizationRequestService = class CtVisualizationRequestService {
...
CtVisualizationRequestService.ctorParameters = () => [
...
let CtVisualizationService = class CtVisualizationService {
    constructor() { }
    generateThreeConstants(canvasEl) {
        const scene = new three__WEBPACK_IMPORTED_MODULE_2__["Scene"]();
        const camera = new three__WEBPACK_IMPORTED_MODULE_2__["PerspectiveCamera"]();
        const renderer = canvasEl ? new three__WEBPACK_IMPORTED_MODULE_2__["WebGLRenderer"]({ canvas: canvasEl }) : new three__WEBPACK_IMPORTED_MODULE_2__["WebGLRenderer"]();
...
//# sourceMappingURL=ct-visualization-ct-visualization-module-es2015.js.map