...
let ConnectedNodesComponent = class ConnectedNodesComponent {
    ...
    configureViewSettings() {
        const light = new three__WEBPACK_IMPORTED_MODULE_3__["AmbientLight"](0x404040); // soft white light
        this.threeCommon.scene.add(light);
        const controls = new three_examples_jsm_controls_OrbitControls__WEBPACK_IMPORTED_MODULE_4__["OrbitControls"](this.threeCommon.camera, this.threeCommon.renderer.domElement);
        //controls.update() must be called after any manual changes to the camera's transform
        this.threeCommon.camera.position.set(0, 0, 5);
        controls.update();
    }
    constructNodes() {
        const geometry = new three__WEBPACK_IMPORTED_MODULE_3__["SphereBufferGeometry"]();
        const material = new three__WEBPACK_IMPORTED_MODULE_3__["MeshPhongMaterial"]({ color: src_app_common_enums_colors_enum__WEBPACK_IMPORTED_MODULE_5__["Colors"].green });
        const node = new three__WEBPACK_IMPORTED_MODULE_3__["Mesh"](geometry, material);
        this.threeCommon.scene.add(node);
        const geometry2 = new three__WEBPACK_IMPORTED_MODULE_3__["SphereBufferGeometry"]();
        const material2 = new three__WEBPACK_IMPORTED_MODULE_3__["MeshPhongMaterial"]({ color: src_app_common_enums_colors_enum__WEBPACK_IMPORTED_MODULE_5__["Colors"].yellow });
        const node2 = new three__WEBPACK_IMPORTED_MODULE_3__["Mesh"](geometry2, material2);
        node2.position.x = 2;
        node.position.x = -2;
        0;
    ...
    constructConnections() {
        const material = new three__WEBPACK_IMPORTED_MODULE_3__["LineBasicMaterial"]({ color: src_app_common_enums_colors_enum__WEBPACK_IMPORTED_MODULE_5__["Colors"].red });
        var points = [];
...
ConnectedNodesComponent.ctorParameters = () => [
...
let GlobeCounteriesComponent = class GlobeCounteriesComponent {
    constructor(threeService) {
        this.threeService = threeService;
    }
    ngOnInit() {
...
GlobeCounteriesComponent.ctorParameters = () => [
...
let GlobePackageComponent = class GlobePackageComponent {
    constructor(threeService) {
        this.threeService = threeService;
    }
    ngOnInit() {
...
GlobePackageComponent.ctorParameters = () => [
    { type: _services_three_service__WEBPACK_IMPORTED_MODULE_3__["ThreeService"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('canvasEl', { static: false, read: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"] })
...
let ThreeGlobeComponent = class ThreeGlobeComponent {
    constructor(threeService) {
        this.threeService = threeService;
    }
    ngOnInit() {
...
ThreeGlobeComponent.ctorParameters = () => [
    { type: _services_three_service__WEBPACK_IMPORTED_MODULE_2__["ThreeService"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('canvasEl', { static: true })
...
let ThreeGlobe3dComponent = class ThreeGlobe3dComponent {
    constructor() { }
    ngOnInit() {
        this.init();
    }
...
let VisualizationThreeComponent = class VisualizationThreeComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let ThreeRoutingModule = class ThreeRoutingModule {
};
...
//# sourceMappingURL=three-three-module-es2015.js.map