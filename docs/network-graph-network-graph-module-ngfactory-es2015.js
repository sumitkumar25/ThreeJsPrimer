...
class GroupLayoutComponent {
    ...
    constructConnection() {
        var material = new three__WEBPACK_IMPORTED_MODULE_2__["LineBasicMaterial"]({ color: 0x0000ff });
        var points = [];
        points.push(this.layoutMesh.geometry);
        points.push(new three__WEBPACK_IMPORTED_MODULE_2__["Vector3"](0, 10, 0));
        points.push(new three__WEBPACK_IMPORTED_MODULE_2__["Vector3"](10, 0, 0));
        var geometry = new three__WEBPACK_IMPORTED_MODULE_2__["BufferGeometry"]().setFromPoints(points);
        var line = new three__WEBPACK_IMPORTED_MODULE_2__["Line"](geometry, material);
