...
/* harmony import */ var three_meshline__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! three.meshline */ "./node_modules/three.meshline/src/THREE.MeshLine.js");
/* harmony import */ var three_meshline__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(three_meshline__WEBPACK_IMPORTED_MODULE_5__);
...
/* harmony import */ var _node_modules_three_examples_jsm_lines_Line2_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./../../../../../node_modules/three/examples/jsm/lines/Line2.js */ "./node_modules/three/examples/jsm/lines/Line2.js");
...
/* harmony import */ var _node_modules_three_examples_jsm_lines_LineGeometry_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./../../../../../node_modules/three/examples/jsm/lines/LineGeometry.js */ "./node_modules/three/examples/jsm/lines/LineGeometry.js");
...
var GroupLayoutComponent = /** @class */ (function () {
    ...
    GroupLayoutComponent.prototype.ngAfterViewInit = function () {
        ...
        this.threeCommon.scene.add(new three__WEBPACK_IMPORTED_MODULE_4__["AxesHelper"](100));
    ...
    GroupLayoutComponent.prototype.initRequests = function () {
        var _this = this;
        Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["forkJoin"])(this.graphRequestService.getGroups(), this.graphRequestService.getNodeMesh()).subscribe(function (_a) {
    ...
    GroupLayoutComponent.prototype.constructNodes = function () {
        var newMesh = !this.instancedNodeMesh;
        if (newMesh) {
            this.instancedNodeMesh = new three__WEBPACK_IMPORTED_MODULE_4__["InstancedMesh"](this.nodeMesh.geometry, this.nodeMesh.material, 10000);
        }
        else {
        ...
        if (this.previousObjectCount > this.objectCount) {
            for (var i = this.objectCount; i < this.previousObjectCount; i++) {
                //using indexes as id.
                var mat = new three__WEBPACK_IMPORTED_MODULE_4__["Matrix4"]();
    ...
    GroupLayoutComponent.prototype.configureConnections = function (type) {
        var connectionData = this.generateRandomConnections();
        switch (type) {
            case "meshline":
    ...
    GroupLayoutComponent.prototype.constructline3Connections = function (connectionData) {
        var _this = this;
        ...
        var geometry = new three__WEBPACK_IMPORTED_MODULE_4__["Geometry"]();
        connectionData.forEach(function (c) {
            geometry.vertices.push(c.source, c.target);
            var line = new three__WEBPACK_IMPORTED_MODULE_4__["Line3"](c.source, c.target);
            // const lineMesh = new THREE.Mesh(line,matLine);
            _this.threeCommon.scene.add(line);
        });
    };
    GroupLayoutComponent.prototype.constructlinefatLineConnections = function (connectionData) {
        var _this = this;
        three__WEBPACK_IMPORTED_MODULE_4__["GeometryUtils"];
        var geometry = new _node_modules_three_examples_jsm_lines_LineGeometry_js__WEBPACK_IMPORTED_MODULE_9__["LineGeometry"]();
        var matLine = new _node_modules_three_examples_jsm_lines_LineMaterial_js__WEBPACK_IMPORTED_MODULE_8__["LineMaterial"]({
            color: 0xffffff,
            linewidth: 5,
            vertexColors: true,
        ...
        connectionData.forEach(function (c) {
            ...
            var line = new _node_modules_three_examples_jsm_lines_Line2_js__WEBPACK_IMPORTED_MODULE_7__["Line2"](geometry, matLine);
            line.computeLineDistances();
            line.scale.set(1, 1, 1);
            _this.threeCommon.scene.add(line);
        });
    };
    GroupLayoutComponent.prototype.constructlineSegment2Connections = function (connectionData) { };
    GroupLayoutComponent.prototype.constructCurveLineConnections = function (connectionData) { };
    GroupLayoutComponent.prototype.constructMeshlineConnections = function (connectionData) {
        this.createConnectionMesh(connectionData);
    };
    GroupLayoutComponent.prototype.constructCylindricalConnections = function (connectionData) {
        var _this = this;
        var HALF_PI = Math.PI * 0.5;
        var material = new three__WEBPACK_IMPORTED_MODULE_4__["MeshLambertMaterial"]({ color: 0x277cb2 });
        connectionData.forEach(function (c) {
            var distance = c.source.distanceTo(c.target);
            var cylinder = new three__WEBPACK_IMPORTED_MODULE_4__["CylinderGeometry"](0.1, 0.1, distance, 10, 10, false);
            // orient the cylinder
            var position = c.target.clone().add(c.source).divideScalar(2);
            var orientation = new three__WEBPACK_IMPORTED_MODULE_4__["Matrix4"](); //a new orientation matrix to offset pivot
            var offsetRotation = new three__WEBPACK_IMPORTED_MODULE_4__["Matrix4"](); //a matrix to fix pivot rotation
            var offsetPosition = new three__WEBPACK_IMPORTED_MODULE_4__["Matrix4"](); //a matrix to fix pivot position
            orientation.lookAt(c.source, c.target, new three__WEBPACK_IMPORTED_MODULE_4__["Vector3"](0, 1, 0)); //look at destination
            offsetRotation.makeRotationX(HALF_PI); //rotate 90 degs on X
            orientation.multiply(offsetRotation); //combine orientation with rotation transformations
            cylinder.applyMatrix4(orientation);
            var mesh = new three__WEBPACK_IMPORTED_MODULE_4__["Mesh"](cylinder, material);
            mesh.position.set(position.x, position.y, position.z);
            mesh.userData['__visualiserObj'] = "traffic";
            _this.threeCommon.scene.add(mesh);
        });
    ...
    GroupLayoutComponent.prototype.generateDistinctConnections = function () {
        var connectionData = [];
        for (var index = 0; index < this.connectionPoints.length; index++) {
            for (var _index = this.connectionPoints.length - 1; _index >= 0; _index = _index - this.connectionStep) {
                connectionData.push({
    ...
    GroupLayoutComponent.prototype.generateRandomConnections = function () {
        var connectionData = [];
        for (var index = 0; index < this.connectionPoints.length; index++) {
            for (var _index = this.connectionPoints.length - 1; _index >= 0; _index = _index - this.connectionStep) {
    ...
    GroupLayoutComponent.prototype.createConnectionMesh = function (connectionData) {
        var _this = this;
        this.connectionCount = connectionData.length / 2;
        if (this.noConnectionMesh) {
            var material_1 = new three_meshline__WEBPACK_IMPORTED_MODULE_5__["MeshLineMaterial"]({
                color: new three__WEBPACK_IMPORTED_MODULE_4__["Color"]("rgb(39,124,178)"),
                opacity: 1,
                lineWidth: 0.05,
                depthTest: true,
                transparent: false,
            ...
            this.trafficGroup = [];
            connectionData.forEach(function (connection, i) {
                if (connectionData[i + 1]) {
                    var meshline = new three_meshline__WEBPACK_IMPORTED_MODULE_5__["MeshLine"]();
                    meshline.setPoints([connectionData[i], connectionData[i + 1]]);
                    var mesh = new three__WEBPACK_IMPORTED_MODULE_4__["Mesh"](meshline, material_1);
                    mesh["dt"] = { test: i };
                    _this.trafficGroup.push(mesh);
                    _this.threeCommon.scene.add(mesh);
                }
            });
        }
        else {
            this.meshline = new three_meshline__WEBPACK_IMPORTED_MODULE_5__["MeshLine"]();
            this.meshline.setPoints(connectionData);
            var material = new three_meshline__WEBPACK_IMPORTED_MODULE_5__["MeshLineMaterial"]({
                color: new three__WEBPACK_IMPORTED_MODULE_4__["Color"]("rgb(39,124,178)"),
                opacity: 1,
                lineWidth: 0.05,
                depthTest: true,
            ...
            this.meshConnections = new three__WEBPACK_IMPORTED_MODULE_4__["Mesh"](this.meshline, material);
            this.meshConnections.frustumCulled = false;
            this.meshConnections.renderOrder = 10;
            this.meshConnections.raycast = three_meshline__WEBPACK_IMPORTED_MODULE_5__["MeshLineRaycast"];
    ...
    GroupLayoutComponent.prototype.clickHandler = function (event) {
        ...
        this.mouse = this.mouse || new three__WEBPACK_IMPORTED_MODULE_4__["Vector3"]();
        this.mouse.x =
