...
var GroupLayoutComponent = /** @class */ (function () {
    ...
    GroupLayoutComponent.prototype.addSpriteTextLabel = function (intersects) {
        ...
        sprite.visible = true;
        var position = this.getLabelPosition(intersects);
        sprite.position.set(position.x, position.y - 1.5, position.z);
        this.threeCommon.scene.add(sprite);
    };
    GroupLayoutComponent.prototype.addSpriteNativeLabel = function (intersects) {
        var sprite = this.constructTooltipLabelSprite("node label" + intersects[0].instanceId);
        var position = this.getLabelPosition(intersects);
        sprite.position.set(position.x, position.y - 3, position.z);
        this.threeCommon.scene.add(sprite);
    };
    GroupLayoutComponent.prototype.constructTooltipLabelSprite = function (text) {
        var font = "Arial";
        var size = 130;
        var color = "#ffffff";
    ...
    GroupLayoutComponent.prototype.getLabelPosition = function (intersects) {
        var matrix = new three__WEBPACK_IMPORTED_MODULE_3__["Matrix4"]();
